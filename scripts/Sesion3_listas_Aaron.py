...
iva =.16 
precio_sin_iva =producto_uno+producto_dos 
precio_iva = (producto_uno*iva)+(producto_dos*iva)
impuesto =  precio_iva-precio_sin_iva
print(f"El precio de cada producto es {producto_uno}")


### 3 Calcular el precio total de una pieza por producto
precio_total_p1=(producto_uno*iva)+producto_uno
print(precio_total_p1)
precio_total_p2=(producto_dos*iva)+producto_dos
print(precio_total_p2)
